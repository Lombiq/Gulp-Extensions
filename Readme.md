...
You have to copy *example.eslintrc* to the root folder of your solution and rename it *.eslintrc*, and specify *lombiq-base.js*'s location inside as described in the file.
